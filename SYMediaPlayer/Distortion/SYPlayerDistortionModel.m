...
@implementation SYPlayerDistortionModel
...
- (instancetype)initWithModelType:(SYPlayerDistortionModelType)modelType
{
    if (self = [super init]) {
...
- (void)setupBufferData
{
    ...
    switch (self.modelType) {
        case SYPlayerDistortionModelTypeLeft:
            break;
        case SYPlayerDistortionModelTypeRight:
